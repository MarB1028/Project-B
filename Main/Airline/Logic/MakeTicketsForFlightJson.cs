...
static class MakeTicketsForFlightJson
{
    public static void MakeTickets(Flight flight)
    {
        ...
        string pathfile = $"C:\\Users\\{Environment.UserName}\\OneDrive\\Git\\Project B\\Project-B\\Main\\Airline\\DataSources\\{flight.Airplane.Name};{flight.Destination.Country};{flight.Destination.City}.json";
